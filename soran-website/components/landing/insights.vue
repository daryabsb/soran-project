<template>
    ...
    <div class="relative isolate overflow-hidden bg-white h-screen w-full">
        ...
        <div class="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                <img class="h-11" src="~/assets/img/logos.2.svg" alt="Your Company" />
                <div class="mt-24 sm:mt-32 lg:mt-16">
                    <a href="#" class="inline-flex space-x-6">
                        <span
                            class="rounded-full bg-red-600/10 px-3 py-1 text-sm font-semibold leading-6 text-red-600 ring-1 ring-inset ring-red-600/10">What's
                            new</span>
            ...
            <div
                ...
                <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                    <div
                        ...
                        <img src="/img/section-insights.jpeg" alt="App screenshot" width="2432" height="1442"
