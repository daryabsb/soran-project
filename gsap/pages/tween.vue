<template>
    <main class="main-content">
        <section ref="sildeshow" class="slideshow">
            <div class="slideshow-inner">
                ...
                <div ref="pages" class="pagination">
...
// const activeSlideImage = ref(null)
...
//     const activeSlideImage.value = activeSlide.find(".image-container");
...
//                 gsap.fromTo(nextSlide, 0.5, { x: "100%" }, { x: "0%" });
//                 gsap.to(activeSlide, 0.5, { x: "-100%" });
//             } else {
//                 const prevSlide = activeSlide.prev(".slide");
//                 gsap.fromTo(prevSlide, 0.5, { x: "-100%" }, { x: "0%" });
//                 gsap.to(activeSlide, 0.5, { x: "100%" });
//             }
//             newSlide.addClass("is-active").removeClass("is-new");
//             activeSlide.removeClass("is-active");
