<template>
    <div class="relative isolate overflow-hidden bg-gray-900 w-full h-full">
        ...
        <div class="mx-auto max-w-7xl px-6 pt-16 pb-24 sm:pb-32 lg:flex lg:py-48 lg:px-8">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">

                <div class="mt-24 sm:mt-32 lg:mt-16">
                    <a href="#" class="inline-flex space-x-6">
                        <span
                            class="rounded-full bg-blood/10 px-3 py-1 text-sm font-semibold leading-6 text-blood ring-1 ring-inset ring-indigo-500/20">What's
                            new</span>
                ...
                <h1 class="mt-10 text-4xl font-montserrat font-thin tracking-tight text-white sm:text-6xl">Deploy to the
                    cloud
                    with
                    confidence</h1>
                ...
                <div class="mt-10 flex items-center gap-x-6">
                    <a href="#"
                        class=" bg-blood px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get
                        started</a>
            ...
            <div
                ...
                <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                    <img src="/img/section-about.jpeg" alt="App screenshot" width="2432" height="1442"
