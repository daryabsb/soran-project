            ...
            <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                <div class="flex">
                    <div
                        ...
                        <span class="font-semibold text-blood">We’re closing</span>
                        <span class="h-4 w-px bg-gray-900/10" aria-hidden="true" />
                        <a href="#" class="flex items-center gap-x-1">
                            <span class="absolute inset-0" aria-hidden="true" />
                            Submissions are getting crowded
                            <ChevronRightIcon class="-mr-2 h-5 w-5 text-gray-400" aria-hidden="true" />
                        </a>
                    </div>
                </div>
                <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Hurry up before
                    it is too late!</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600">Esse id magna consectetur fugiat non dolor in ad laboris
                    magna laborum ea consequat. Nisi irure aliquip nisi adipisicing veniam voluptate id. In veniam
                    incididunt ex veniam adipisicing sit.</p>
